...
# path to test data
test_path = "D:\\Term2_Fourth_Year\\CSDLDPT\\DemoCSDLPT\\dataset\\test2"
# get the training labels
...
for testing_name in test_labels:
    ...
    for file in glob.glob(dir + "\\*.jpg"):
        ...
        cv2.putText(image, train_labels[y_pred[i]], (50, 50),
...
print("Result: ", (y_pred == y_result).tolist().count(True)/len(y_pred))
